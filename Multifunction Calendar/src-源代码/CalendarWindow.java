...
MouseListener,FocusListener{
   ...
   // JComboboxTest weatherReport;
    ...
    File dir;
    //image background =new CalenderImage();
    //background
    //calendarImage=new CalendarImage();
    //calendarImage.setImageFile(new File("sense.jpg"));
    Color backColor=Color.white; //Color
    ...
    public  CalendarWindow(){
       ...
       notePad=new NotePad();  
       Calendar calendar=Calendar.getInstance(); //The Calendar returned is based on the current time 
       ...
       calendarPad.showMonthCalendar(year,month,day);
       doMark();  //给有日志的号码做标记,见后面的doMark()方法
       calendarImage=new CalendarImage();
      File file1=new File("sense.jpg");
      File file2=new File("2.jpg");
      calendarImage.setImageFile(file1);
       clock=new Clock();
    // clock.setImageFile(file2);
    // weatherReport=new JComboboxTest();
      ...
      String stime=String.format("%tT",date);
       String htime=from+" "+stime;
       ttime=new JButton("今天  "+htime);
